...
-- CreateEnum
CREATE TYPE "StatusRole" AS ENUM ('pending', 'in_progress', 'completed');
...
CREATE TABLE "tasks" (
    ...
    "priority" "PriorityRole" NOT NULL DEFAULT 'low',
...
CREATE TABLE "tasks_history" (
    ...
    "old_status" "StatusRole" NOT NULL,
    "new_status" "StatusRole" NOT NULL,
